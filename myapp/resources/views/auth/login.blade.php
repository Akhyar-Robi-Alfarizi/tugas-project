    ...
    <div class="flex">
        ...
        <div class="w-1/2 h-screen flex justify-center items-center">
            <div class="w-3/4 max-w-md">
                ...
                <form method="POST" action="{{ route('login.attempt') }}" class="flex flex-col space-y-4">
                    @csrf
                    ...
                    @if ($errors->any())
                    <p class="text-sm text-red-600 mt-2">Login gagal. Coba lagi.</p>
                    @endif

                    <p class="text-sm text-gray-600">
                        Sudah punya akun? <a href="{{ route('register') }}" class="text-blue-600 hover:underline">Masuk di sini</a>
                    </p>
                </form>
