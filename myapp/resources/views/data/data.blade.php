...
<head>
  ...
  {{-- Tailwind via Vite (kalau ada), jika tidak pakai CDN --}}
  ...
  {{-- Hindari modal “kedip” sebelum Alpine siap --}}
...
<body class="font-sans antialiased">
  <div class="flex min-h-[80vh]">
    ...
    >
      ...
      <a href="{{ route('siswa.create') }}"
         class="mt-6 inline-flex items-center rounded-md bg-[#4B78AF] px-4 py-2 text-white shadow hover:bg-[#405875]">
        + Tambah Siswa
      </a>
              ...
              <tr class="text-sm">
                ...
                <td class="px-6 py-3">
                  <div class="flex gap-2">
                    ...
                    {{-- Tombol buka modal Tailwind + Alpine --}}
                    <button type="button"
                      @click="open('{{ route('siswa.destroy', $s) }}', '{{ $s->nama }}')"
      ...
      >
        ...
        >
          ...
          <h2 class="mb-2 text-center text-lg font-semibold text-gray-900">Hapus siswa ini?</h2>
          <p class="mb-6 text-center text-sm text-gray-600">
            Data <span class="font-medium text-gray-800" x-text="info.nama"></span> akan dihapus permanen.
          </p>
  ...
  {{-- Komponen Alpine untuk kontrol modal --}}
  <script>
    function confirmBox(){
      return {
        show: false,
